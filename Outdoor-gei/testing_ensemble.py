...
# %%
gallery_images_head, gallery_infos_head, probe_images_head, probe_infos_head = load_testing_data_gei('D:/OutdoorGei/5part/1_PART/test','cl_cl')
gallery_images_chest1, gallery_infos_chest1, probe_images_chest1, probe_infos_chest1 = load_testing_data_gei('D:/OutdoorGei/5part/2_PART/test','cl_cl')
gallery_images_chest2, gallery_infos_chest2, probe_images_chest2, probe_infos_chest2 = load_testing_data_gei('D:/OutdoorGei/5part/3_PART/test','cl_cl')
gallery_images_foot, gallery_infos_foot, probe_images_foot, probe_infos_foot = load_testing_data_gei('D:/OutdoorGei/5part/4_PART/test','cl_cl')
gallery_images_foot2, gallery_infos_foot2, probe_images_foot2, probe_infos_foot2 = load_testing_data_gei('D:/OutdoorGei/5part/5_PART/test','cl_cl')
...
for i in range(5):  
    model_ens_head = Net(69)  
    model_ens_head.load_state_dict(torch.load(f'D:/WEIGHTS/Outdoor_Gei/5Part/Ensembles/models_kfold/Part1_models/ensemble_Part1_model__{i}.pth'))
...
for i in range(5):  
    model_ens_chest1 = Net(69)  
    model_ens_chest1.load_state_dict(torch.load(f'D:/WEIGHTS/Outdoor_Gei/5Part/Ensembles/models_kfold/Part2_models/ensemble_Part2_model__{i}.pth'))
...
for i in range(5):  
    model_ens_chest2 = Net(69)  
    model_ens_chest2.load_state_dict(torch.load(f'D:/WEIGHTS/Outdoor_Gei/5Part/Ensembles/models_kfold/Part3_models/ensemble_Part3_model__{i}.pth'))
...
for i in range(5):  
    model_ens_foot = Net(69)  
    model_ens_foot.load_state_dict(torch.load(f'D:/WEIGHTS/Outdoor_Gei/5Part/Ensembles/models_kfold/Part4_models/ensemble_Part4_model__{i}.pth'))
...
for i in range(5):  
    model_ens_foot2 = Net(69)  
    model_ens_foot2.load_state_dict(torch.load(f'D:/WEIGHTS/Outdoor_Gei/5Part/Ensembles/models_kfold/Part5_models/ensemble_Part5_model__{i}.pth'))
