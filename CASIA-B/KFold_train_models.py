...
for k, (train_index, val_index) in enumerate(skf.split(x_train, y_train_int)):
    ...
    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART_WITHOUT_VARIATION/kfold/models_kfold_PART1/ensemble_PART1_model__{k}.pth')
    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART_WITHOUT_VARIATION/kfold/models_kfold_PART2/ensemble_PART2_model__{k}.pth')
    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART_WITHOUT_VARIATION/kfold/models_kfold_PART3/ensemble_PART3_model__{k}.pth')
    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART_WITHOUT_VARIATION/kfold/models_kfold_PART4/ensemble_PART4_model__{k}.pth')
    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART_WITHOUT_VARIATION/kfold/models_kfold_PART5/ensemble_PART5_model__{k}.pth')

    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART/kfold/models_kfold_PART5/ensemble_PART1_model__{k}.pth')
    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART/kfold/models_kfold_PART5/ensemble_PART2_model__{k}.pth')
    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART/kfold/models_kfold_PART5/ensemble_PART3_model__{k}.pth')
    # torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART/kfold/models_kfold_PART5/ensemble_PART4_model__{k}.pth')
    torch.save(model.state_dict(), f'D:/WEIGHTS/CASIA_B/5PART/kfold/models_kfold_PART5/ensemble_PART5_model__{k}.pth')
